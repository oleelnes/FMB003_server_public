...
internal class AvlParserKtTest {
    //IMPORTANT!! SEE THE APPENDIX IN THESIS FOR THE AVL STRINGS BELOW.
    //THEY WERE REDACTED FROM THE REPOSITORY BECAUSE THEY INCLUDE SENSITIVE INFORMATION AS THEY WERE FROM REAL-WORLD TESTING.
